...
def get_doc_owner_name(p, user_doc_number):
...
def delete_doc(d, user_doc_number):
    # user_doc_number = input('Введите номер документа - ')
    doc_exist = check_document_existance(user_doc_number)
    if doc_exist:
        for current_document in documents:
...
def get_doc_shelf(s, user_doc_number):
    # user_doc_number = input('Введите номер документа - ')
    doc_exist = check_document_existance(user_doc_number)
    if doc_exist:
        for directory_number, directory_docs_list in directories.items():
...
def move_doc_to_shelf(m, user_doc_number, user_shelf_number) -> tuple:
    # user_doc_number = input('Введите номер документа - ')
...
def add_new_doc(a, new_doc_number, new_doc_type, new_doc_owner_name, new_doc_shelf_number):
